...
public:
	...
	void drawRectangle(const Position& topLeft, const Dimension& sz) {
		...
		/*draw(topLeft, (unsigned char)176);
		draw(Position{ topLeft.x + sz.x, topLeft.y }, 176);
		draw(topLeft.x, topLeft.y + sz.y, (unsigned char)176);
		draw(topLeft.x + sz.x, topLeft.y + sz.y, (unsigned char)176);*/
	}	
